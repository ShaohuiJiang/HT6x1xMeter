...
*                        @arg INT_EXTIE_RIE
*                        @arg INT_EXTIE2_RIE_INT7   (only for HT6x2x)         
*                        @arg INT_EXTIE2_RIE_INT8   (only for HT6x2x)
*                        @arg INT_EXTIE2_RIE_INT9   (only for HT6x2x)
*                        @arg INT_EXTIE2_RIE
*
*
...
*                        @arg INT_EXTIE_FIE
*                        @arg INT_EXTIE2_FIE_INT7  (only for HT6x2x)           
*                        @arg INT_EXTIE2_FIE_INT8  (only for HT6x2x)
*                        @arg INT_EXTIE2_FIE_INT9  (only for HT6x2x)
*                        @arg INT_EXTIE2_FIE
*
*           NewState   = ENABLE： 使能中断
*                      = DISABLE：关闭中断
...
*                        @arg INT_EXTIF2_RIF_INT7   (only for HT6x2x)
*                        @arg INT_EXTIF2_RIF_INT8   (only for HT6x2x)
*                        @arg INT_EXTIF2_RIF_INT9   (only for HT6x2x)
*
...
*                        @arg INT_EXTIF2_FIF_INT7     (only for HT6x2x)
*                        @arg INT_EXTIF2_FIF_INT8     (only for HT6x2x)
*                        @arg INT_EXTIF2_FIF_INT9     (only for HT6x2x)
*
* 返回参数: ITStatus    = SET：  相应中断标志产生
*                       = RESET：相应中断标志未产生
* 
...
*                        @arg INT_PINFLT2_INTFLT_INT7  (only for HT6x2x)           
*                        @arg INT_PINFLT2_INTFLT_INT8  (only for HT6x2x)
*                        @arg INT_PINFLT2_INTFLT_INT9  (only for HT6x2x)
*
*           NewState   = ENABLE： 使能中断
*                      = DISABLE：关闭中断
* 返回参数: 无                                      
