...
*                        @arg TBS_TBSPRD_ADC2PRD_32S   
*                                                  
*                             VREFPRD:
*                        @arg TBS_TBSPRD_VREFPRD_1S    
*                        @arg TBS_TBSPRD_VREFPRD_4S    
...
*                     @arg CMP_ADC0     ：ADC0比较寄存器      (only for HT501x, HT6x2x)
*                     @arg CMP_ADC1     ：ADC1比较寄存器      (only for HT501x)
*
* 返回参数: 无                                      
* 
* 特殊说明: 无
