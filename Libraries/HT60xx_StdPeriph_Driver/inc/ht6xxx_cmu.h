...
{ 
    ...
    SysHRCDiv1 = (CMU_SYSCLKCFG_CLKSEL_HRC|0x00), /*!< Fsys = 外部高频RC时钟/1          */
    SysHRCDiv2 = (CMU_SYSCLKCFG_CLKSEL_HRC|0x10), /*!< Fsys = 外部高频RC时钟/2          */
    SysHRCDiv4 = (CMU_SYSCLKCFG_CLKSEL_HRC|0x20), /*!< Fsys = 外部高频RC时钟/4          */
    SysHRCDiv8 = (CMU_SYSCLKCFG_CLKSEL_HRC|0x30), /*!< Fsys = 外部高频RC时钟/8          */
